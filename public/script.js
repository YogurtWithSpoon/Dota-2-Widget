$(document).ready(function () {
  ...
  function updateInfo() {
    ...
    $.get("readJSON", function (data) {
      ...
      //update page
      team1.setAttribute("src", "http://f0302262.xsph.ru/teams/teams/" + pageData.team1 + ".png");
      team2.setAttribute("src", "http://f0302262.xsph.ru/teams/teams/" + pageData.team2 + ".png");
